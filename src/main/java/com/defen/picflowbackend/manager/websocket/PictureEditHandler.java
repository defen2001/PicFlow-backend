...
import com.defen.picflowbackend.manager.websocket.disruptor.PictureEditEventProducer;
import com.defen.picflowbackend.manager.websocket.model.PictureEditActionEnum;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    private void broadcastToPicture(Long pictureId, PictureEditResponseMessage pictureEditResponseMessage, WebSocketSession excludeSession) throws Exception {
        Set<WebSocketSession> webSocketSst = pictureSessions.get(pictureId);
        if (CollUtil.isNotEmpty(webSocketSst)) {
            // 创建 ObjectMapper
            ...
            for (WebSocketSession Session : webSocketSst) {
                // 排除掉的 session 不发送
